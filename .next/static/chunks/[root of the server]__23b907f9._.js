(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__23b907f9._.js", {
...
function Home() {
    ...
    const fetchData = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3001/api/data', {
                headers: {
            ...
            if (error.response && error.response.status === 401) {
                try {
                    if (ticket === null) {
                        const ticketResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:3001/api/ticket');
            ...
            if (ticket) {
                const interval = setInterval({
                    "Home.useEffect.interval": async ()=>{
                        try {
                            const tokenResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(`http://localhost:3001/api/token`, {
                                ticketId: ticket
                            });
...
_s(Home, "dt/DRIkwnyBPNGceXrx4CAZgKII=");
_c = Home;
var _c;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__23b907f9._.js.map